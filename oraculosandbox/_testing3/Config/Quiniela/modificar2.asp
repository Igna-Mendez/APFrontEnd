...
<%
Response.Expires = 0
if (Request.Form("txtQuiniela") <> "") and (Request.Form("hiIdQuiniela") <> "") Then
...
spUpQuiniela.Parameters.Append spUpQuiniela.CreateParameter("@idQuiniela", 20, 1, 9, Request.Form("hiIdQuiniela"))
