...
<link rel="stylesheet" href="style_poceadas3.css" type="text/css" >
</head>
...
//          echo      $sql_cartones ;
      ...
      {  
           ...
           {   
              ...
              { 
                 $i++;
                 echo'<td align="middle" class="Estilo9" background="http://www.oraculosemanal.com/images/bg_hdr.jpg" ><div align="center" class="Estilo9">' . $Datos_num['numero'] . '<strong></td>';
                 if ($i == $cant)
                 {
                    echo '</tr><tr>';
                    $i =0 ;
           ...
           if (mssql_num_rows($rs_PRemios2) > 0 )
           {
              ...
              echo '  <center>';
              echo '    <table cellspacing="5" cellpadding="5" width="160" border="0">';
              echo '      <tbody>';
              echo '        <tr>';
