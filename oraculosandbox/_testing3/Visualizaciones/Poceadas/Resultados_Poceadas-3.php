...
//          echo      $sql_cartones ;
      ...
      {  
           ...
           {   
              ...
              { 
                 $i++;
                 echo'<td align="middle" class="Estilo9" background="/images/bg_hdr.jpg" ><div align="center" class="Estilo13">' . $Datos_num['numero'] . '<strong></td>';
                 if ($i == $cant)
                 {
                    echo '</tr><tr>';
                    $i =0 ;
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" background="/images/footer-bg.png">
  <tr>
    <td height="35" background="/images/topnav_bg.gif">&nbsp;</td>
  </tr>
  <tr>
