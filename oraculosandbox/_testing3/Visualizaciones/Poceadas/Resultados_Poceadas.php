  ...
  <tr>
    ...
    <table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="568"><table border="0" align="right" cellpadding="1" cellspacing="10">
          <tr>
            <td height="101"><iframe id="itsfogo77465" name="itsfogo77465" src="http://adserver.itsfogo.com/default.aspx?t=f&v=1&zoneid=77465" frameborder="0" scrolling="no" width="546" height="90"></iframe>
                <br /></td>
          </tr>
        </table></td>
      </tr>
    ...
    <div id="header">
      <ul class="topnav">
            ...
            <li>
                <a href="#">Poceados</a>
                <ul class="subnav">
                    <li><a href="http://www.oraculosemanal.com/_testing3/Visualizaciones/Poceadas/Resultados_Poceadas.php?idPoceada=2">LOTO</a></li>
                    <li><a href="http://www.oraculosemanal.com/_testing3/Visualizaciones/Poceadas/Resultados_Poceadas.php?idPoceada=11">TELEKINO</a></li>
                    <li><a href="http://www.oraculosemanal.com/_testing3/Visualizaciones/Poceadas/Resultados_Poceadas.php?idPoceada=10">QUINI 6</a></li>
                    <li><a href="http://www.oraculosemanal.com/_testing3/Visualizaciones/Poceadas/Resultados_Poceadas.php?idPoceada=3">LOTO 5</a></li>
                    <li><a href="http://www.oraculosemanal.com/_testing3/Visualizaciones/Poceadas/Resultados_Poceadas.php?idPoceada=4">BRINCO</a></li>
                    <li><a href="http://www.oraculosemanal.com/_testing3/Visualizaciones/Poceadas/Resultados_Poceadas.php?idPoceada=5">MI MINGO</a></li>
                    <li><a href="http://www.oraculosemanal.com/_testing3/Visualizaciones/Poceadas/Resultados_Poceadas.php?idPoceada=7">Mono Bingo</a></li>
                    <li><a href="http://www.oraculosemanal.com/_testing3/Visualizaciones/Poceadas/Resultados_Poceadas.php?idPoceada=8">La Poceada</a></li>
                    <li><a href="http://www.oraculosemanal.com/_testing3/Visualizaciones/Poceadas/Resultados_Poceadas.php?idPoceada=1">Quiniela Plus</a></li>
                    <li><a href="http://www.oraculosemanal.com/_testing3/Visualizaciones/Poceadas/Resultados_Poceadas.php?idPoceada=9">Club Keno</a></li>
                    <li><a href="http://www.oraculosemanal.com/_testing3/Visualizaciones/Poceadas/Resultados_Poceadas.php?idPoceada=6">Toto Bingo</a></li>
                    <li><a href="http://www.oraculosemanal.com/_testing3/Visualizaciones/Poceadas/Resultados_Poceadas.php?idPoceada=12">Juga con Maradona</a></li>
                </ul>
            </li>
            <li><a href="#">Tablas</a>
                            <ul class="subnav">
...
//          echo      $sql_cartones ;
          ...
          if (mssql_num_rows($rs_numeros2) > 0 )
          {
              echo '<table cellspacing="5" cellpadding="10" width="300" border="0">
                     <tbody>
                       <tr>
                         <td colspan="3" align="middle" background="http://www.oraculosemanal.com/images/bgfade.gif"><strong class="Estilo4">' . $Datos['TipoPoceado'] . '</strong></td>
                       </tr>';
      ...
      {  
           ...
           if (mssql_num_rows($rs_PRemios2) > 0 )
           {
              ...
              {
                  echo '        <tr>';
                  echo '          <td colspan="3" align="middle" background="http://www.oraculosemanal.com/images/bgfade.gif"><strong class="Estilo4" >' . $Datos['TipoPoceado'] . '</strong></td>';
                  echo '        </tr>'; 
              }
              echo '        <tr>';
...
Function monobingo($resultado)
{
   while($Datos = mssql_fetch_array($resultado) )
   {
       ...
       Premios($Datos['IdSorteoPoceado']);
    
       if ($Datos['IdSorteoPoceado']  <> 0)
       { 
         cartones($Datos['IdSorteoPoceado'], $Datos['TipoPoceado'] );
       }
       
   }
}

function cartones($IdSorteoPoceado,  $TipoPoceado)
{
  ...
  // echo $sql_cartones;
   ...
   if (mssql_num_rows($rs_numeros2) > 0 )
   {
       ...
       echo '<tbody>';
       echo '  <tr>';
       echo '    <td colspan="2" align="middle" background="http://www.oraculosemanal.com/images/bgfade.gif"><strong class="Estilo4">' . $TipoPoceado . '</strong></td>';
       echo '  </tr>';                       
...
Function Premios($IdSorteoPoceado)
{
   $SQL_PRemios = 'SELECT Aciertos, Ganadores, Monto, IdSorteoPoceado
                     FROM Premios
                    WHERE IdSorteoPoceado = '. $IdSorteoPoceado ;    
   $rs_PRemios = mssql_query($SQL_PRemios);
   $rs_PRemios2 = mssql_query($SQL_PRemios);       
   if (mssql_num_rows($rs_PRemios2) > 0 )
   {
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" background="http://www.oraculosemanal.com/images/footer-bg.png">
  ...
  <tr>
    <td><table width="400" border="0" align="center">
      <tr>
        <td height="70"><div align="center"><span class="Estilo6">© 2010 Oraculosemanal.com. Todos los derechos reservados.</span> </div></td>
      </tr>
    </table></td>
  </tr>
</table>
