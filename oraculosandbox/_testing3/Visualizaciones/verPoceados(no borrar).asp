...
<body>
<iframe id="datamain" src="./../Visualizaciones/<%=archivoMuestra%>?idPoceado=<%=Request.QueryString("idPoceado")%>&fechaSorteo=<%=Request.QueryString("fechaSorteo")%>" width="200px" height="72px" marginwidth="0" marginheight="0" hspace="0" vspace="0" frameborder="0" scrolling="no">
</iframe>
