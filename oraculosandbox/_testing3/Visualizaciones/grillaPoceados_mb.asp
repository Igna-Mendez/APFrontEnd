    ...
    <tr>
      <td><table width="400" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="10"><img src="http://www.oraculosemanal.com/images/tl_left.gif" width="10" height="19"></td>
            <td width="80" background="http://www.oraculosemanal.com/images/tl_bg.gif"><div align="center" class="Estilo2"><%=day(rsSorteo("fechaSorteo"))&"/"&month(rsSorteo("fechaSorteo"))&"/"&year(rsSorteo("fechaSorteo"))%></div></td>
            <td width="10"><img src="http://www.oraculosemanal.com/images/tl_right.gif" width="10" height="19"></td>
          </tr>
              </table></td>
    </tr>
...
<%if (j = 0) then
	cant = 2%>
	</tr><tr><td><div align="center" class="Estilo2">Línea</div></td></tr><tr>
<%end if%>
<%if (j = 2) then
	cant = 1%>
	</tr><tr><td><div align="center" class="Estilo2">Pancita</div></td></tr><tr>
<%end if%>
<%if (j = 3) then
	cant = 1%>
	</tr><tr><td><div align="center" class="Estilo2">Código de la Suerte</div></td></tr><tr>
<%end if%>

  	<td><div align="center">
  	  <table width="100" height="100" border="0" cellpadding="0" cellspacing="0" background="../images/ball_fondo.gif">
          <tr>
            <td><div align="center" class="Estilo3"><%=rsNumero("numero")%></div></td>
          </tr>
        </table>
  	</div></td>
<%
