...
{ $extra_folder = (integer) ($result[0] / 10000); 
	$print .=" width=55 height=55><a href=http://".$BASE."/afiliados/tracking.asp?SiteID=".$SiteID."&idu=".$IDU."&UrlTo=http://".$BASE."/accdb/viewitem.asp?IDI=".$result[0]."><img width=55 height=55 border=0 src=http://".$BASE."/user/images/".$extra_folder."/".$result[0]."_p.jpg></a></td>";
};	
$print .="<td align=left with=100%><a class=\"titulo\" href=http://".$BASE."/afiliados/tracking.asp?SiteID=".$SiteID."&idu=".$IDU."&UrlTo=http://".$BASE."/accdb/viewitem.asp?IDI=".$result[0].">".$result[1]."</a><br><span class=\"precio\">".$result[2]."".$result[3]."</span></td></table>";
if ($h==$COLUMNAS){
$print .="</tr>";		
$h=1;
}else{
