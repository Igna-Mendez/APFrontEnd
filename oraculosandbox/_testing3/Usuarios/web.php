...
Function grilla_sorteos_cabecera($tipo)
{
   ...
   echo '<form name="form1" id="form1" method="POST" > ';
	...
	echo '    <td width="80"><div align="center" class="cabecera_numeros"><div align="left"><input type="text" name="fecha[]"  value="' . $fecha_armada . '" maxlength="10" size="7" class="clsNode" onBlur="esFechaValida(this);" ></div></div></td>';
...
*/
  ...
  function SMS_mensaje_Col()
  {
      $fecha = getdate();
      $anio = $fecha[year];
      $Mes = $fecha[mon];
      $dia =  $fecha[mday];
      //echo '<form  method="post" action="sms.php" target="_blank" > ';
       echo '<form name="form1" id="form1" method="POST" > ';
         datos_tablaopen (' width="360" align="center" border=0 ');
             datos_tablaRowsOpen;
           	       datos_tabladata('Quiniela a Enviar ', ' class="maintitle" colspan="3"   align="Center" ');
             datos_tablaRowsClose();
                           
              datos_tablaRowsOpen;
  						    datos_tabladata('Loteria : ', ' class="tituloMenu"  align="right" ');
  						    datos_tabladata('&nbsp;', '');
  						    //cargo_combos( "Cmd_loteria", "quinielas", "QUINIELA", "IDQUINIELA"  );
                            cargo_combos(  "Cmd_quiniela", "quinielas ", "quiniela", "idquiniela", '' , 'blanco','',' style="width:80px" align="left" ', '' );
  			  datos_tablaRowsClose();
       ...
       datos_tablaRowsOpen('');
           datos_tabladata('<div align="center"><input type="button" value="SMS" onClick="ventanasms();" class="button" ></div>',' colspan="3" ');
       datos_tablaRowsClose();
