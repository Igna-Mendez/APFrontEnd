<?php
  ...
  $Contraseña = MD5($_POST['Nueva_pass']);


  $SQL_INS = "INSERT INTO usuarios (Nombre, Apellido, Usuario, Contrasenia, FechaAlta ) VALUES
		                            ('$Nombre', '$Apellido', '$Usuario', '$Contraseña', getdate() )";
