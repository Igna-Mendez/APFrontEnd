...
Sub DoEmail(email, user_name)
    ...
    ' ###  if you don't have one, try the w3Jmail component from www.dimac.net it's free!
    	...
    	From = "mail@killersnetwork.com"
	Subject = "Respuesta a su mensaje"
	msg = "Estimado " & user_name & vbcrlf & vbcrlf
	msg = msg & "Ha recibido una respuesta a su mensaje perteneciente a " & BBtitle
	msg = msg & "El mensaje original se encuentra en el Tema: " & Request.Form("topic_title") & "." & vbcrlf & vbcrlf
	msg = msg & "Usted puede ver esta respuesta en " & Request.Form("refer") & vbcrlf
	
Set myMail = server.createobject("cdonts.newmail")
myMail.send email , from , subject , msg , 0
Set Mymail=Nothing%>
...
<a href="<%= Request.Form("refer")%>">Back To Forum</a>
</font></center>
</body>
</html>
<%	
