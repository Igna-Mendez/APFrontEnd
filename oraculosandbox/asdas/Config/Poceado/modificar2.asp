...
<%
Response.Expires = 0
if (Request.Form("txtPoceado") <> "") and (Request.Form("hiIdPoceado") <> "") Then
...
spUpPoceado.Parameters.Append spUpPoceado.CreateParameter("@idPoceado", 20, 1, 9, Request.Form("hiIdPoceado"))
spUpPoceado.Parameters.Append spUpPoceado.CreateParameter("@poceado", 200, 1,50, Request.Form("txtPoceado"))
spUpPoceado.Parameters.Append spUpPoceado.CreateParameter("@codpoceado", 200, 1,5, "")
spUpPoceado.Execute()
end if
