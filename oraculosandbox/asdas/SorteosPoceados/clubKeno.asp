...
%>	
  ...
  <tr><td><div align="center"><input name="txtNumero" type="text" size="5" maxlength="2">
    ...
    <table width="500" border="0">
  <tr><td><div align="center"><input name="txtTexto" type="text" size="20" maxlength="500">
      </div></td>
      <td><div align="center">
        <input name="txtTexto" type="text" size="20" maxlength="500">
      </div></td>
      <td><div align="center">
        <input name="txtTexto" type="text" size="20" maxlength="500">
      </div></td>
  ...
  <input name="hiCodPoceado" type="hidden" id="hiCodPoceado" value="CK">
  <input name="hiTipos" type="hidden" id="hiCodPoceado" value="UNICO">
  <input name="UNICO" type="hidden" id="hiCodPoceado" value="txtNumero,falso,falso,falso,txtTexto">
</form>
</body>
</html>
