...
<table width="500" border="0">
    <tr>
      <td width="395">Quiniela Super Plus</td>
    </tr>
    <tr>
  ...
  <table width="500" border="0">
    <tr>
      <td><div align="center">
        <input name="txtNumero2" type="text" size="5" maxlength="2">
      </div></td>
      <td><div align="center">
        <input name="txtNumero2" type="text" size="5" maxlength="2">
      </div></td>
  ...
  <table width="500" border="0">
    ...
    <tr>
      <td><div align="center">
        <input name="txtAciertos2" type="text" id="txtAciertos2" size="5" maxlength="2">
      </div></td>
      <td><div align="center">
  ...
  <input name="hiCodPoceado" type="hidden" id="hiCodPoceado" value="QP">
  <input name="hiTipos" type="hidden" id="hiCodPoceado" value="QP,QU">
  <input name="QP" type="hidden" id="hiCodPoceado" value="txtNumero,txtAciertos,txtGanadores,txtCobra,falso">
  <input name="QU" type="hidden" id="hiCodPoceado" value="txtNumero2,txtAciertos2,txtGanadores2,txtCobra2,falso">
</form>
</body>
</html>
