...
//-------------------Los Primeros----------------------			
			...
			if(mssql_result($rsSorteo, $i, "idquinielaP") == "1" && mssql_result($rsSorteo, $i, "losprimeros")!="--") {
				...
				$divsLosP .= '			<div class="col-md-4 col-sm-6 wow fadeInDown span3 tiny " data-wow-duration="1000ms" data-wow-delay="600ms">
			...
			elseif(mssql_result($rsSorteo, $i, "idquinielaP") == "2" && mssql_result($rsSorteo, $i, "losprimeros")!="--") {
				...
				$divsLosP .= '			<div class="col-md-4 col-sm-6 wow fadeInDown span3 small " data-wow-duration="1000ms" data-wow-delay="600ms">
			...
			elseif(mssql_result($rsSorteo, $i, "idquinielaP") == "11" && mssql_result($rsSorteo, $i, "losprimeros") != "--"){
				...
				$divsLosP .= '			<div class="col-md-4 col-sm-6 wow fadeInDown span3 medium " data-wow-duration="1000ms" data-wow-delay="600ms">
...
//------------------------Vespertina-------------------------------			
			...
			if(mssql_result($rsSorteo, $i, "idquinielaP") == "1" && mssql_result($rsSorteo, $i, "vespertina")!="--") {
				...
				$divsVesp .= '			<div class="col-md-4 col-sm-6 wow fadeInDown span3 tiny " data-wow-duration="1000ms" data-wow-delay="600ms">
					<div class="pricing-table-header-tiny ">
						<h2><a href="http://www.oraculosemanal.com/_testing3/Visualizaciones/iframeSorteos.asp?idQuiniela='.mssql_result($rsSorteo, $i, "idQuinielaP").'">'.iconv('Windows-1252', 'UTF-8//TRANSLIT', mssql_result($rsSorteo, $i, "quiniela")).'</a></h2>
					</div>
					<div class="section ">
			...
			elseif(mssql_result($rsSorteo, $i, "idquinielaP") == "2" && mssql_result($rsSorteo, $i, "vespertina")!="--") {
				...
				$divsVesp .= '			<div class="col-md-4 col-sm-6 wow fadeInDown span3 small " data-wow-duration="1000ms" data-wow-delay="600ms">
					<div class="pricing-table-header-small ">
						<h2><a href="http://www.oraculosemanal.com/_testing3/Visualizaciones/iframeSorteos.asp?idQuiniela='.mssql_result($rsSorteo, $i, "idQuinielaP").'">'.iconv('Windows-1252', 'UTF-8//TRANSLIT', mssql_result($rsSorteo, $i, "quiniela")).'</a></h2>
					</div>
			...
			elseif(mssql_result($rsSorteo, $i, "idquinielaP") == "11" && mssql_result($rsSorteo, $i, "vespertina") != "--"){
				...
				$divsVesp .= '			<div class="col-md-4 col-sm-6 wow fadeInDown span3 medium " data-wow-duration="1000ms" data-wow-delay="600ms">
					<div class="pricing-table-header-medium ">
						<h2><a href="http://www.oraculosemanal.com/_testing3/Visualizaciones/iframeSorteos.asp?idQuiniela='.mssql_result($rsSorteo, $i, "idQuinielaP").'">'.iconv('Windows-1252', 'UTF-8//TRANSLIT', mssql_result($rsSorteo, $i, "quiniela")).'</a></h2>
					</div>
					<div class="section ">
				...
				if(mssql_result($rsSorteo, $i, "vespertina")!="--") {
					...
					$divsVespElse .= '			<div class="col-md-4 col-sm-6 wow fadeInDown span3 supertiny " data-wow-duration="1000ms" data-wow-delay="600ms">
						<div class="pricing-table-header-supertiny ">
							<h2><a href="http://www.oraculosemanal.com/_testing3/Visualizaciones/iframeSorteos.asp?idQuiniela='.mssql_result($rsSorteo, $i, "idQuinielaP").'">'.iconv('Windows-1252', 'UTF-8//TRANSLIT', mssql_result($rsSorteo, $i, "quiniela")).'</a></h2>
						</div>
						<div class="section ">
