...
function getDBCoincidences($str, $dbhandle) {
	...
	$num = mssql_num_rows($rsCoincidences);

	if($num > 0) {		
		return $rsCoincidences;
	} else {
		$coincidence = 'No se Encontro una coincidencia, consulte nuestras tablas';
		return $coincidence;	
	}
}
...
if( isset($_POST['numeros'])) {
	if($_POST['numeros']!=''){
		$coincidencias=getDBCoincidences($_POST['numeros'], $dbhandle);		
	}
			...
			//0 -> Id | 1 -> oficios | 2 -> sueños1 | 3 -> simpaticos1 | 4 -> simpaticos2 | 5 -> datelli | 6 -> animales | 7 -> sueños2
				...
				$divs .= '			<div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                    <div class="feature-wrap">
                        <a href="http://www.oraculosemanal.com/oficios.htm">Oficio: '.iconv('Windows-1252', 'UTF-8//TRANSLIT', mssql_result($coincidencias, 0, 1)).'</a>
                    </div>
                </div><!--/.col-md-4-->';
				$divs .= '			<div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                    <div class="feature-wrap">
                        <a href="http://www.oraculosemanal.com/suenios.htm">Soñó con: '.iconv('Windows-1252', 'UTF-8//TRANSLIT', mssql_result($coincidencias, 0, 2)).'</a>
                    </div>
                </div><!--/.col-md-4-->';
				$divs .= '			<div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                    <div class="feature-wrap">
                        <a href="http://www.oraculosemanal.com/martingala1.htm">Martingala Números simpaticos 1:'.iconv('Windows-1252', 'UTF-8//TRANSLIT', mssql_result($coincidencias, 0, 3)).'</a>
                    </div>
                </div><!--/.col-md-4-->';
				$divs .= '			<div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                    <div class="feature-wrap">
                        <a href="http://www.oraculosemanal.com/martingala2.htm">Martingala Números simpaticos 2:'.iconv('Windows-1252', 'UTF-8//TRANSLIT', mssql_result($coincidencias, 0, 4)).'</a>
                    </div>
                </div><!--/.col-md-4-->';
				$divs .= '			<div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                    <div class="feature-wrap">
                        <a href="http://www.oraculosemanal.com/tablita.htm">Tablita Datelli: '.iconv('Windows-1252', 'UTF-8//TRANSLIT', mssql_result($coincidencias, 0, 5)).'</a>
                    </div>
                </div><!--/.col-md-4-->';
				$divs .= '			<div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                    <div class="feature-wrap">
                        <a href="http://www.oraculosemanal.com/animales.htm">Amimal: '.iconv('Windows-1252', 'UTF-8//TRANSLIT', mssql_result($coincidencias, 0, 6)).'</a>
                    </div>
                </div><!--/.col-md-4-->';
				$divs .= '			<div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                    <div class="feature-wrap">
                        <a href="">Sueños: '.iconv('Windows-1252', 'UTF-8//TRANSLIT', mssql_result($coincidencias, 0, 7)).'</a>
                    </div>
                </div><!--/.col-md-4-->';
