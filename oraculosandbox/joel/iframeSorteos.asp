  ...
  <table width="950" height="600" border="0" align="center">
	<tr align="center">
	  ...
	  <td width="768" align="center"><iframe name="datamain1" id="datamain1"  src="ConsultaResultadoQuinielaBootsrtapdragdrop.php?idQuiniela=<%=Request.Querystring("idQuiniela")%>" width="768px" height="900px" marginwidth="0" marginheight="0" hspace="0" vspace="0" frameborder="0" scrolling="yes"></iframe></td>
	</tr>
  </table>
  <br>
  <table width="140" border="0" align="center">
	<tr>
	  <td><div align="center">
		<a href="javascript:doit()"><img src="http://www.oraculosemanal.com/images/icono_imprimir.gif" width="17" height="17" border=0></a>
  ...
  function buscar()
  {
	  document.frBuscador.action = "ConsultaResultadoQuinielaBootsrtapdragdrop.php?idQuiniela="+<%=Request.Querystring("idQuiniela")%>+"&fechaSorteo="+document.frBuscador.selMes.value+"/"+document.frBuscador.selDia.value+"/"+document.frBuscador.selAnio.value
	  return
  }
